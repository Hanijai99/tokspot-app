// FCM Messaging Service Worker — handles background push notifications.
...
messaging.onBackgroundMessage((payload) => {
  const title = payload.notification ? payload.notification.title : 'Token Alert';
  ...
  self.registration.showNotification(title, { body, icon: './icons/icon.svg', badge: './icons/icon.svg', tag });
});
